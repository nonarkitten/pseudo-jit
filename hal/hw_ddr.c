...
void DDRInit(void) {
  ...
  VTP_CTRL = 0;
  VTP_CTRL = __builtin_bswap32(6);
  VTP_CTRL = __builtin_bswap32(70);
  /*clears flops  start count again*/
  VTP_CTRL = __builtin_bswap32(71);
  /*wait ready*/
  while (!(VTP_CTRL & __builtin_bswap32(32)))
    ;

  /*DDR Phy CMD0*/
  CMD0_REG_PHY_CTRL_SLAVE_RATIO_0 = __builtin_bswap32(CMD_PHY_CTRL_SLAVE_RATIO);
  CMD0_REG_PHY_INVERT_CLKOUT_0 = __builtin_bswap32(CMD_PHY_INVERT_CLKOUT);
  /*DDR Phy CMD1*/
  CMD1_REG_PHY_CTRL_SLAVE_RATIO_0 = __builtin_bswap32(CMD_PHY_CTRL_SLAVE_RATIO);
  CMD1_REG_PHY_INVERT_CLKOUT_0 = __builtin_bswap32(CMD_PHY_INVERT_CLKOUT);
  /*DDR Phy CMD2*/
  CMD2_REG_PHY_CTRL_SLAVE_RATIO_0 = __builtin_bswap32(CMD_PHY_CTRL_SLAVE_RATIO);
  CMD2_REG_PHY_INVERT_CLKOUT_0 = __builtin_bswap32(CMD_PHY_INVERT_CLKOUT);

  /*Init Data Macro 0*/
  DATA0_REG_PHY_RD_DQS_SLAVE_RATIO_0 =
      __builtin_bswap32(DATA_PHY_RD_DQS_SLAVE_RATIO);
  DATA0_REG_PHY_WR_DQS_SLAVE_RATIO_0 =
      __builtin_bswap32(DATA_PHY_WR_DQS_SLAVE_RATIO);
  DATA0_REG_PHY_FIFO_WE_SLAVE_RATIO_0 =
      __builtin_bswap32(DATA_PHY_FIFO_WE_SLAVE_RATIO);
  DATA0_REG_PHY_WR_DATA_SLAVE_RATIO_0 =
      __builtin_bswap32(DATA_PHY_WR_DATA_SLAVE_RATIO);
  /*Init Data Macro 1*/
  ...
  /**/
  DDR_CMD0_IOCTRL = __builtin_bswap32(DDR_IOCTRL_VALUE);
  DDR_CMD1_IOCTRL = __builtin_bswap32(DDR_IOCTRL_VALUE);
  DDR_CMD2_IOCTRL = __builtin_bswap32(DDR_IOCTRL_VALUE);
  DDR_DATA0_IOCTRL = __builtin_bswap32(DDR_IOCTRL_VALUE);
  DDR_DATA1_IOCTRL = __builtin_bswap32(DDR_IOCTRL_VALUE);

  // IO to work for DDR3
  DDR_IO_CTRL &= ~__builtin_bswap32(0x10000000);

  // CKE controlled by EMIF/DDR_PHY
  DDR_CKE_CTRL = __builtin_bswap32(0x00000001);

  for (int i = 0; i < 50000; i++) asm("    nop");

  /**/
  EMIF_DDR_PHY_CTRL_1 = __builtin_bswap32(ALLOPP_DDR3_READ_LATENCY);
  EMIF_DDR_PHY_CTRL_1_SHDW = __builtin_bswap32(ALLOPP_DDR3_READ_LATENCY);
  EMIF_DDR_PHY_CTRL_2 = __builtin_bswap32(ALLOPP_DDR3_READ_LATENCY);
  /**/
  EMIF_SDRAM_TIM_1 = __builtin_bswap32(ALLOPP_DDR3_SDRAM_TIMING1);
  EMIF_SDRAM_TIM_1_SHDW = __builtin_bswap32(ALLOPP_DDR3_SDRAM_TIMING1);
  EMIF_SDRAM_TIM_2 = __builtin_bswap32(ALLOPP_DDR3_SDRAM_TIMING2);
  EMIF_SDRAM_TIM_2_SHDW = __builtin_bswap32(ALLOPP_DDR3_SDRAM_TIMING2);
  EMIF_SDRAM_TIM_3 = __builtin_bswap32(ALLOPP_DDR3_SDRAM_TIMING3);
  EMIF_SDRAM_TIM_3_SHDW = __builtin_bswap32(ALLOPP_DDR3_SDRAM_TIMING3);

  EMIF_SDRAM_REF_CTRL = __builtin_bswap32(ALLOPP_DDR3_REF_CTRL);
  EMIF_SDRAM_REF_CTRL_SHDW = __builtin_bswap32(ALLOPP_DDR3_REF_CTRL);

  EMIF_ZQ_CONFIG = __builtin_bswap32(ALLOPP_DDR3_ZQ_CONFIG);
  EMIF_SDRAM_CONFIG = __builtin_bswap32(ALLOPP_DDR3_SDRAM_CONFIG);

  while (!(EMIF_STATUS & __builtin_bswap32(4)))
    ;
}
